...
const REWARDS = [
  ...
  { id: 2, amount: "$0.25", color: "text-[#14A990]" },
  { id: 3, amount: "$200", color: "text-[#F59E0B]", highlight: true },
  { id: 4, amount: "$0.05", color: "text-[#14A990]" },
  { id: 5, amount: "$0.25", color: "text-[#14A990]" },
  { id: 6, amount: "$0.25", color: "text-[#14A990]" },
];
        ...
        <div className="flex flex-col items-center">
              ...
              {REWARDS.map((reward) => (
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-[#1E2F3F]/50 flex items-center justify-center text-[#0AC07D]">
                    <Disc size={32} className={reward.highlight ? "animate-spin-slow" : ""} />
                  </div>
          ...
          <div className="w-full max-w-[900px] mb-8">
            ...
            <div className="flex justify-between mt-3">
              ...
              <span className="px-3 py-1 bg-[#14A990] rounded-full text-[10px] font-bold">$2</span>
            </div>
          </div>

          <p className="text-[#8C9DB6] text-center font-bold text-sm sm:text-base mb-8">
            Earn over $1 within 48 hours and receive <span className="text-[#0AC07D]">3 more free cases</span>
          </p>
